...
function setup() {
  ...
  var url = 'https://docs.google.com/spreadsheets/d/1J0d9HZXRUkJZbyy1Dub9rlDdTvxybeW69b41QBxjM3I/pubhtml';
  ...
  function gotData(data) {
    ...
    for (var i = 0; i < data.length; i++) {
      var item = createElement('li', data[i].Description + ': ' + data[i].Rating + ", submited at " + data[i].Timestamp);
      item.parent(list);
    }
  }
}
